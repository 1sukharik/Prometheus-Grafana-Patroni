...
SELECT pg_catalog.setval('public.address_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.admin_user_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.cart_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.logistic_company_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.notification_type_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.platform_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.refund_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.shipment_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.shipment_method_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.support_ticket_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.ticket_message_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.tracking_info_id_seq', 20, true);
